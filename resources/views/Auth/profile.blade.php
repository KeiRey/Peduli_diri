        ...
        <div class="col-md-12 mt-5">
            <form method="POST" action="/profile" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input id="nik" maxlength="16" type="nik" class="form-control @error('nik') is-invalid @enderror"
                        name="nik" value="{{ $user->nik }}" required autocomplete="nik">
                ...
                <div>
                    <div class="flex-grow-1">
                        <div class="form-group">
                            <label for="email" class="col-form-label text-md-right">Provinsi, Kota, Kecamatan,
                                Kelurahan</label>
                ...
                <div class="form-group ">
                    ...
                    <input id="gambar" type="file" class="form-control @error('gambar') is-invalid @enderror" name="gambar"
                        value="{{ $user->gambar }}" autocomplete="gambar">
                ...
                <div class="form-group ">
                    ...
                    <input id="no_telp" maxlength="12" type="text"
                        class="form-control @error('no_telp') is-invalid @enderror" name="no_telp"
                        value="{{ $user->no_telp }}" required autocomplete="no_telp" autofocus>
