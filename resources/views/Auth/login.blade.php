	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-b-160 p-t-50">
				<form class="login100-form validate-form" method="POST" action="/postlogin">@csrf
					<span class="login100-form-title p-b-43">
						Account Login
					</span>
					
					<div class="wrap-input100 rs1 validate-input" data-validate = "Email Tidak Boleh Kosong">
						<input class="input100" type="text" name="email">
						<span class="label-input100">Email</span>
					</div>
					
					
					<div class="wrap-input100 rs2 validate-input" data-validate="Password Tidak Boleh Kosog">
					...
					<div class="text-center w-full p-t-23">
						<a href="{{ route('registrasi') }}" class="txt1">
							Ga Punya Akun
						</a>
					</div>
				</form>
